...
| **6** | Safety/LAD generation + distributed ET200SP: emit LAD & F-LAD (FlgNet SimaticML), build ET200SP PROFINET stations with F-modules, set 1oo2 F-parameters | Yes | in progress - **feasibility proven** ([SAFETY-LAD-SPIKE.md](SAFETY-LAD-SPIKE.md)); driven by the SR PPS project |
