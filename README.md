...
- **[docs/DESIGN-SHEET.md](docs/DESIGN-SHEET.md)** — the design-workbook schema contract (**v1.9**): tabs, columns, enums, the eight build phases, and every validation rule `Test-TiaDesignSheet` enforces. This is the input side of the safety pipeline.
